...
live2d_settings['tipsMessage']          = 'https://cdn.jsdelivr.net/gh/MKJ-TMZ/live2d-1.09/assets/waifu-tips.json';            // 同目录下可省略路径
...
live2d_settings['waifuMinWidth']        = '900px';      // 面页小于 指定宽度 隐藏看板娘，例如 'disable'(禁用), '768px'
...
live2d_settings['aboutPageUrl']         = 'https://mkj-tmz.xyz/';   // 关于页地址, '{URL 网址}'
